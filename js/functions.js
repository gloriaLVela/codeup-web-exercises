...
// and stores it in a variable named random
    ...
    var tip = Number(prompt("Enter tip percentage")) / 100;
    alert('Tip amount ' + calculateTip(tip, amount));

    console.log(calculateTip(tip, amount), tip, amount);
...
// var discountPct = Number(prompt("Enter discount"))/100;.
...
// console.log(applyDiscount(price,discountPct), price, discountPct);
